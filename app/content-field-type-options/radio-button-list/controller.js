app.controller('contentFieldTypeOptionsRadioButtonListController', ['$scope', '$uibModal', function ($scope, $uibModal) {
    ...
    $scope.addChoice = function () {
        ...
        modalInstance.result.then(
            function (retChoice) {
                if (!$scope.contentField.options.choices) {
                    $scope.contentField.options.choices = [];
                }
                var newChoice = {
                    text: retChoice.text,
